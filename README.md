...
- [X] Mention two parts of Express that you learned about this week.
    ...
    - How to set up a server and routes. and using .listen.
...
- [X] Describe a Resource?
    ...
    - Something that can be stored on a backend database and have CRUD operations    performed on it.
...
- [X] How can we partition our application into sub-applications?
    ...
    - Through the use of Routes. Importing and Exporting.
